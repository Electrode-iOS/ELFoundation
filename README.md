...
[![Version](https://img.shields.io/badge/version-v1.0.2-blue.svg)](https://github.com/Electrode-iOS/ELFoundation/releases/latest)
...
```
github "Electrode-iOS/ELFoundation" ~> 1.0.2
```
