...
[![Version](https://img.shields.io/badge/version-v1.1.1-blue.svg)](https://github.com/Electrode-iOS/ELFoundation/releases/latest)
...
```
github "Electrode-iOS/ELFoundation" ~> 1.1.1
```
