...
*/
public func setAssociatedObject<T>(_ object: AnyObject, value: T, associativeKey: UnsafePointer<Void>, policy: objc_AssociationPolicy) {
    //print("set, T = \(T.self)")
...
like Arrays and whatnot where mutability is involved.
*/
public func getAssociatedObject<T>(_ object: AnyObject, associativeKey: UnsafePointer<Void>) -> T! {
